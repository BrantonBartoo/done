...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2025 at 08:03 AM
...
CREATE TABLE `bursary_applications` (
  ...
  `amount_granted` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `bursary_applications` (`id`, `user_id`, `financial_situation`, `funding_sources`, `bursary_impact`, `academic_achievements`, `academic_challenges`, `academic_goals`, `personal_circumstances`, `study_balance`, `support_systems`, `career_aspirations`, `community_contribution`, `skills_experiences`, `motivation`, `resilience_example`, `engagement_plan`, `extracurriculars`, `unique_qualities`, `additional_info`, `submission_date`, `status`, `amount_requested`, `amount_granted`) VALUES
(6, 9, 'rgergerg', 'fdgvdfbgg', 'fdgdfgasdf', 'gdfagfg', 'adgadfg', 'gfadgafgfdag', 'fdgfgfg', 'adfgfdgf', 'afgdfgg', 'fgfagadf', 'fgadfgd', 'afgfgf', 'afdgfgf', 'fdgdfgadf', 'afdgfdgf', 'adfgdfgf', 'adfgfga', 'fagfgfg', '2025-04-30 05:29:39', 'approved', NULL, 50000);
...
(9, 'bet12', 'beto@example.com', '$2y$10$gbOfFoRsBkgVxP6sGfYE0eoY2OxeNXAhl0xlrhTgqrjW2X/NkZ4uy', '2025-04-30 04:57:23', 'Pending', 'f1.jpg', 0);
